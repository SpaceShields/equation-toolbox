...
const GoToToolboxButton = () => {
  return (
    <Link href="/mytoolboxes">
        <div className='lg:tooltip lg:tooltip-bottom lg:tooltip-accent' data-tip="Toolbox">
...
export default GoToToolboxButton